    ...
    createLoadBalancerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateLoadBalancerRequestToJSON)(requestParameters.createLoadBalancerRequest),
            }, initOverrides);
    ...
    createLoadBalancerTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CreateLoadBalancerTagsRequestToJSON)(requestParameters.createLoadBalancerTagsRequest),
            }, initOverrides);
    ...
    deleteLoadBalancerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteLoadBalancerRequestToJSON)(requestParameters.deleteLoadBalancerRequest),
            }, initOverrides);
    ...
    deleteLoadBalancerTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteLoadBalancerTagsRequestToJSON)(requestParameters.deleteLoadBalancerTagsRequest),
            }, initOverrides);
    ...
    deregisterVmsInLoadBalancerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeregisterVmsInLoadBalancerRequestToJSON)(requestParameters.deregisterVmsInLoadBalancerRequest),
            }, initOverrides);
    ...
    linkLoadBalancerBackendMachinesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.LinkLoadBalancerBackendMachinesRequestToJSON)(requestParameters.linkLoadBalancerBackendMachinesRequest),
            }, initOverrides);
    ...
    readLoadBalancerTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadLoadBalancerTagsRequestToJSON)(requestParameters.readLoadBalancerTagsRequest),
            }, initOverrides);
    ...
    readLoadBalancersRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadLoadBalancersRequestToJSON)(requestParameters.readLoadBalancersRequest),
            }, initOverrides);
    ...
    readVmsHealthRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadVmsHealthRequestToJSON)(requestParameters.readVmsHealthRequest),
            }, initOverrides);
    ...
    registerVmsInLoadBalancerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.RegisterVmsInLoadBalancerRequestToJSON)(requestParameters.registerVmsInLoadBalancerRequest),
            }, initOverrides);
    ...
    unlinkLoadBalancerBackendMachinesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UnlinkLoadBalancerBackendMachinesRequestToJSON)(requestParameters.unlinkLoadBalancerBackendMachinesRequest),
            }, initOverrides);
    ...
    updateLoadBalancerRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateLoadBalancerRequestToJSON)(requestParameters.updateLoadBalancerRequest),
            }, initOverrides);
