    ...
    createImageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateImageRequestToJSON)(requestParameters.createImageRequest),
            }, initOverrides);
    ...
    createImageExportTaskRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CreateImageExportTaskRequestToJSON)(requestParameters.createImageExportTaskRequest),
            }, initOverrides);
    ...
    deleteImageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteImageRequestToJSON)(requestParameters.deleteImageRequest),
            }, initOverrides);
    ...
    readImageExportTasksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadImageExportTasksRequestToJSON)(requestParameters.readImageExportTasksRequest),
            }, initOverrides);
    ...
    readImagesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadImagesRequestToJSON)(requestParameters.readImagesRequest),
            }, initOverrides);
    ...
    updateImageRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateImageRequestToJSON)(requestParameters.updateImageRequest),
            }, initOverrides);
