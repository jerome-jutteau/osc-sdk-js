    ...
    createTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateTagsRequestToJSON)(requestParameters.createTagsRequest),
            }, initOverrides);
    ...
    deleteTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteTagsRequestToJSON)(requestParameters.deleteTagsRequest),
            }, initOverrides);
    ...
    readTagsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadTagsRequestToJSON)(requestParameters.readTagsRequest),
            }, initOverrides);
