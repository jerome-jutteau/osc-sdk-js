    ...
    createSnapshotRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateSnapshotRequestToJSON)(requestParameters.createSnapshotRequest),
            }, initOverrides);
    ...
    createSnapshotExportTaskRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.CreateSnapshotExportTaskRequestToJSON)(requestParameters.createSnapshotExportTaskRequest),
            }, initOverrides);
    ...
    deleteSnapshotRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteSnapshotRequestToJSON)(requestParameters.deleteSnapshotRequest),
            }, initOverrides);
    ...
    readSnapshotExportTasksRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadSnapshotExportTasksRequestToJSON)(requestParameters.readSnapshotExportTasksRequest),
            }, initOverrides);
    ...
    readSnapshotsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadSnapshotsRequestToJSON)(requestParameters.readSnapshotsRequest),
            }, initOverrides);
    ...
    updateSnapshotRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateSnapshotRequestToJSON)(requestParameters.updateSnapshotRequest),
            }, initOverrides);
