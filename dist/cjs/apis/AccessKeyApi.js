    ...
    createAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateAccessKeyRequestToJSON)(requestParameters.createAccessKeyRequest),
            }, initOverrides);
    ...
    deleteAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteAccessKeyRequestToJSON)(requestParameters.deleteAccessKeyRequest),
            }, initOverrides);
    ...
    readAccessKeysRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadAccessKeysRequestToJSON)(requestParameters.readAccessKeysRequest),
            }, initOverrides);
    ...
    readSecretAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadSecretAccessKeyRequestToJSON)(requestParameters.readSecretAccessKeyRequest),
            }, initOverrides);
    ...
    updateAccessKeyRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateAccessKeyRequestToJSON)(requestParameters.updateAccessKeyRequest),
            }, initOverrides);
