    ...
    createVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateVmsRequestToJSON)(requestParameters.createVmsRequest),
            }, initOverrides);
    ...
    deleteVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteVmsRequestToJSON)(requestParameters.deleteVmsRequest),
            }, initOverrides);
    ...
    readAdminPasswordRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadAdminPasswordRequestToJSON)(requestParameters.readAdminPasswordRequest),
            }, initOverrides);
    ...
    readConsoleOutputRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadConsoleOutputRequestToJSON)(requestParameters.readConsoleOutputRequest),
            }, initOverrides);
    ...
    readVmTypesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadVmTypesRequestToJSON)(requestParameters.readVmTypesRequest),
            }, initOverrides);
    ...
    readVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadVmsRequestToJSON)(requestParameters.readVmsRequest),
            }, initOverrides);
    ...
    readVmsStateRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadVmsStateRequestToJSON)(requestParameters.readVmsStateRequest),
            }, initOverrides);
    ...
    rebootVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.RebootVmsRequestToJSON)(requestParameters.rebootVmsRequest),
            }, initOverrides);
    ...
    startVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.StartVmsRequestToJSON)(requestParameters.startVmsRequest),
            }, initOverrides);
    ...
    stopVmsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.StopVmsRequestToJSON)(requestParameters.stopVmsRequest),
            }, initOverrides);
    ...
    updateVmRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.UpdateVmRequestToJSON)(requestParameters.updateVmRequest),
            }, initOverrides);
