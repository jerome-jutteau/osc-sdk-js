    ...
    createKeypairRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, models_1.CreateKeypairRequestToJSON)(requestParameters.createKeypairRequest),
            }, initOverrides);
    ...
    deleteKeypairRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.DeleteKeypairRequestToJSON)(requestParameters.deleteKeypairRequest),
            }, initOverrides);
    ...
    readKeypairsRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                headers: headerParameters,
                query: queryParameters,
                body: (0, models_1.ReadKeypairsRequestToJSON)(requestParameters.readKeypairsRequest),
            }, initOverrides);
