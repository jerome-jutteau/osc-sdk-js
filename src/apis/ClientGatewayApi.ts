...
export interface ClientGatewayApiInterface {
     ...
     */
    createClientGatewayRaw(requestParameters: CreateClientGatewayOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateClientGatewayResponse>>;

    /**
     */
    createClientGateway(requestParameters: CreateClientGatewayOperationRequest, initOverrides?: RequestInit): Promise<CreateClientGatewayResponse>;
     ...
     * @memberof ClientGatewayApiInterface
     */
    deleteClientGatewayRaw(requestParameters: DeleteClientGatewayOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteClientGatewayResponse>>;

    /**
     */
    deleteClientGateway(requestParameters: DeleteClientGatewayOperationRequest, initOverrides?: RequestInit): Promise<DeleteClientGatewayResponse>;
     ...
     * @memberof ClientGatewayApiInterface
     */
    readClientGatewaysRaw(requestParameters: ReadClientGatewaysOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadClientGatewaysResponse>>;

    /**
     */
    readClientGateways(requestParameters: ReadClientGatewaysOperationRequest, initOverrides?: RequestInit): Promise<ReadClientGatewaysResponse>;
...
export class ClientGatewayApi extends runtime.BaseAPI implements ClientGatewayApiInterface {
    ...
    /**
     */
    async createClientGatewayRaw(requestParameters: CreateClientGatewayOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateClientGatewayResponse>> {
    ...
    /**
     */
    async createClientGateway(requestParameters: CreateClientGatewayOperationRequest = {}, initOverrides?: RequestInit): Promise<CreateClientGatewayResponse> {
    ...
    /**
     */
    async deleteClientGatewayRaw(requestParameters: DeleteClientGatewayOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteClientGatewayResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async deleteClientGateway(requestParameters: DeleteClientGatewayOperationRequest = {}, initOverrides?: RequestInit): Promise<DeleteClientGatewayResponse> {
    ...
    /**
     */
    async readClientGatewaysRaw(requestParameters: ReadClientGatewaysOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadClientGatewaysResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async readClientGateways(requestParameters: ReadClientGatewaysOperationRequest = {}, initOverrides?: RequestInit): Promise<ReadClientGatewaysResponse> {
