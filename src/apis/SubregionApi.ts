...
export interface SubregionApiInterface {
     ...
     */
    readSubregionsRaw(requestParameters: ReadSubregionsOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadSubregionsResponse>>;

    /**
     */
    readSubregions(requestParameters: ReadSubregionsOperationRequest, initOverrides?: RequestInit): Promise<ReadSubregionsResponse>;
...
export class SubregionApi extends runtime.BaseAPI implements SubregionApiInterface {
    ...
    /**
     */
    async readSubregionsRaw(requestParameters: ReadSubregionsOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadSubregionsResponse>> {
    ...
    /**
     */
    async readSubregions(requestParameters: ReadSubregionsOperationRequest = {}, initOverrides?: RequestInit): Promise<ReadSubregionsResponse> {
