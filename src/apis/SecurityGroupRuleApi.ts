...
export class SecurityGroupRuleApi extends runtime.BaseAPI implements SecurityGroupRuleApiInterface {
    ...
    /**
     */
    async createSecurityGroupRuleRaw(requestParameters: CreateSecurityGroupRuleOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateSecurityGroupRuleResponse>> {
    ...
    /**
     */
    async createSecurityGroupRule(requestParameters: CreateSecurityGroupRuleOperationRequest = {}, initOverrides?: RequestInit): Promise<CreateSecurityGroupRuleResponse> {
    ...
    /**
     */
    async deleteSecurityGroupRuleRaw(requestParameters: DeleteSecurityGroupRuleOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteSecurityGroupRuleResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async deleteSecurityGroupRule(requestParameters: DeleteSecurityGroupRuleOperationRequest = {}, initOverrides?: RequestInit): Promise<DeleteSecurityGroupRuleResponse> {
