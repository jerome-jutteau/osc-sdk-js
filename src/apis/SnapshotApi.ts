...
export interface SnapshotApiInterface {
     ...
     */
    createSnapshotRaw(requestParameters: CreateSnapshotOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateSnapshotResponse>>;

    /**
     */
    createSnapshot(requestParameters: CreateSnapshotOperationRequest, initOverrides?: RequestInit): Promise<CreateSnapshotResponse>;
     ...
     * @memberof SnapshotApiInterface
     */
    createSnapshotExportTaskRaw(requestParameters: CreateSnapshotExportTaskOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateSnapshotExportTaskResponse>>;

    /**
     */
    createSnapshotExportTask(requestParameters: CreateSnapshotExportTaskOperationRequest, initOverrides?: RequestInit): Promise<CreateSnapshotExportTaskResponse>;
     ...
     * @memberof SnapshotApiInterface
     */
    deleteSnapshotRaw(requestParameters: DeleteSnapshotOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteSnapshotResponse>>;

    /**
     */
    deleteSnapshot(requestParameters: DeleteSnapshotOperationRequest, initOverrides?: RequestInit): Promise<DeleteSnapshotResponse>;
     ...
     * @memberof SnapshotApiInterface
     */
    readSnapshotExportTasksRaw(requestParameters: ReadSnapshotExportTasksOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadSnapshotExportTasksResponse>>;

    /**
     */
    readSnapshotExportTasks(requestParameters: ReadSnapshotExportTasksOperationRequest, initOverrides?: RequestInit): Promise<ReadSnapshotExportTasksResponse>;
     ...
     * @memberof SnapshotApiInterface
     */
    readSnapshotsRaw(requestParameters: ReadSnapshotsOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadSnapshotsResponse>>;

    /**
     */
    readSnapshots(requestParameters: ReadSnapshotsOperationRequest, initOverrides?: RequestInit): Promise<ReadSnapshotsResponse>;
     ...
     * @memberof SnapshotApiInterface
     */
    updateSnapshotRaw(requestParameters: UpdateSnapshotOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UpdateSnapshotResponse>>;

    /**
     */
    updateSnapshot(requestParameters: UpdateSnapshotOperationRequest, initOverrides?: RequestInit): Promise<UpdateSnapshotResponse>;
...
export class SnapshotApi extends runtime.BaseAPI implements SnapshotApiInterface {
    ...
    /**
     */
    async createSnapshotRaw(requestParameters: CreateSnapshotOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateSnapshotResponse>> {
    ...
    /**
     */
    async createSnapshot(requestParameters: CreateSnapshotOperationRequest = {}, initOverrides?: RequestInit): Promise<CreateSnapshotResponse> {
    ...
    /**
     */
    async createSnapshotExportTaskRaw(requestParameters: CreateSnapshotExportTaskOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateSnapshotExportTaskResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async createSnapshotExportTask(requestParameters: CreateSnapshotExportTaskOperationRequest = {}, initOverrides?: RequestInit): Promise<CreateSnapshotExportTaskResponse> {
    ...
    /**
     */
    async deleteSnapshotRaw(requestParameters: DeleteSnapshotOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteSnapshotResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async deleteSnapshot(requestParameters: DeleteSnapshotOperationRequest = {}, initOverrides?: RequestInit): Promise<DeleteSnapshotResponse> {
    ...
    /**
     */
    async readSnapshotExportTasksRaw(requestParameters: ReadSnapshotExportTasksOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadSnapshotExportTasksResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async readSnapshotExportTasks(requestParameters: ReadSnapshotExportTasksOperationRequest = {}, initOverrides?: RequestInit): Promise<ReadSnapshotExportTasksResponse> {
    ...
    /**
     */
    async readSnapshotsRaw(requestParameters: ReadSnapshotsOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadSnapshotsResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async readSnapshots(requestParameters: ReadSnapshotsOperationRequest = {}, initOverrides?: RequestInit): Promise<ReadSnapshotsResponse> {
    ...
    /**
     */
    async updateSnapshotRaw(requestParameters: UpdateSnapshotOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UpdateSnapshotResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async updateSnapshot(requestParameters: UpdateSnapshotOperationRequest = {}, initOverrides?: RequestInit): Promise<UpdateSnapshotResponse> {
