...
export interface CaApiInterface {
     ...
     */
    createCaRaw(requestParameters: CreateCaOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateCaResponse>>;

    /**
     */
    createCa(requestParameters: CreateCaOperationRequest, initOverrides?: RequestInit): Promise<CreateCaResponse>;
     ...
     * @memberof CaApiInterface
     */
    deleteCaRaw(requestParameters: DeleteCaOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteCaResponse>>;

    /**
     */
    deleteCa(requestParameters: DeleteCaOperationRequest, initOverrides?: RequestInit): Promise<DeleteCaResponse>;
     ...
     * @memberof CaApiInterface
     */
    readCasRaw(requestParameters: ReadCasOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadCasResponse>>;

    /**
     */
    readCas(requestParameters: ReadCasOperationRequest, initOverrides?: RequestInit): Promise<ReadCasResponse>;
     ...
     * @memberof CaApiInterface
     */
    updateCaRaw(requestParameters: UpdateCaOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UpdateCaResponse>>;

    /**
     */
    updateCa(requestParameters: UpdateCaOperationRequest, initOverrides?: RequestInit): Promise<UpdateCaResponse>;
...
export class CaApi extends runtime.BaseAPI implements CaApiInterface {
    ...
    /**
     */
    async createCaRaw(requestParameters: CreateCaOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CreateCaResponse>> {
    ...
    /**
     */
    async createCa(requestParameters: CreateCaOperationRequest = {}, initOverrides?: RequestInit): Promise<CreateCaResponse> {
    ...
    /**
     */
    async deleteCaRaw(requestParameters: DeleteCaOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<DeleteCaResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async deleteCa(requestParameters: DeleteCaOperationRequest = {}, initOverrides?: RequestInit): Promise<DeleteCaResponse> {
    ...
    /**
     */
    async readCasRaw(requestParameters: ReadCasOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ReadCasResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async readCas(requestParameters: ReadCasOperationRequest = {}, initOverrides?: RequestInit): Promise<ReadCasResponse> {
    ...
    /**
     */
    async updateCaRaw(requestParameters: UpdateCaOperationRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<UpdateCaResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async updateCa(requestParameters: UpdateCaOperationRequest = {}, initOverrides?: RequestInit): Promise<UpdateCaResponse> {
